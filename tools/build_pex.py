...
def build_pex(platform: str, out_dir: Path) -> None:
    ...
    cmd = [
        ...
        "--output-file", str(pex_path),
        "--entry-point", "qp_cli:main",
        "-r", "requirements.txt",
        "."
    ]
...
def main():
    ...
    parser.add_argument("--platform", required=True, help="Target platform (macos-latest, ubuntu-latest, windows-latest)")
