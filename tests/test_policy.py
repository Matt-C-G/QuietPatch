...
from src.core.policy import _SEV_RANK, Policy, apply_policy
    ...
    test_data = [
        {
            "app": "TestApp1",
            "version": "1.0",
            "cves": [{"severity": "unknown", "cvss": 7.5}, {"severity": "low", "cvss": 3.0}],
        },
        {
            "app": "TestApp2",
            "version": "2.0",
            "cves": [{"severity": "unknown", "cvss": 9.0}, {"severity": "unknown", "cvss": 2.0}],
        },
    ]
