...
import tempfile
import json
from report.html import generate_report, _action_cell, _first_cve
...
def test_action_cell_generation():
    ...
    # Test with command
    rec_with_cmd = {
        "actions": [{"cmd": "test command", "note": "test note"}]
    }
    ...
    # Test with URL
    rec_with_url = {
        "actions": [{"url": "https://example.com", "note": "test url"}]
    }
...
def test_first_cve_extraction():
    ...
    rec = {
        "cves": [
            {"id": "CVE-2023-1234", "cvss": 7.5, "severity": "high", "summary": "Test CVE"}
        ]
    }
